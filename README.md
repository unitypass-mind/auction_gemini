...
**🔄 Week 4 (Day 11-12): NCP 서버 배포**
- Naver Cloud Platform 서버 생성
- Nginx + Gunicorn 프로덕션 환경 구축
...
1. **Firebase 설정** (30분)
   - [FIREBASE_SETUP.md](./FIREBASE_SETUP.md) 가이드 따라 실행
   - Firebase 프로젝트 생성 및 서비스 계정 키 다운로드

2. **NCP 서버 배포** (4-6시간)
   - [NCP_DEPLOYMENT_GUIDE.md](./NCP_DEPLOYMENT_GUIDE.md) 가이드 따라 실행
   - 서버 인스턴스 생성 및 배포
...
**마지막 업데이트**: 2026-03-05
**프로젝트 진행률**: 75% (Week 3 완료)
**다음 마일스톤**: NCP 서버 배포 (Week 4, Day 11-12)
